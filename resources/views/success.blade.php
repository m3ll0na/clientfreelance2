                ...
                <table style="border: none; margin-left: auto; margin-right: auto" cellpadding="0" cellspacing="0" width="600" class="content">
                    ...
                    <tr>
                        <td class="general center">
                            ...
                            <p class="big"><i class="fa-regular fa-circle-check fa-3x"></i></p>
                            <p>Congratulations.<br>Your freelancer will contact you within 24 hours</p>
                            <p class="small"><a href="#">Close</a></p>
                        </td>
                    </tr>
