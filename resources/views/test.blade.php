                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="timetable-item">  
                        ...
                        <div class="timetable-item-main">
                          <div class="timetable-item-time">9:00am - 10:00am</div>
                          <div class="timetable-item-name">Available</div>
                          <a href="/client" class="btn btn-primary btn-book">Book</a>
                    ...
                    <div class="col-md-6">
                      <div class="timetable-item"> 
                        ...
                        <div class="timetable-item-main">
                          <div class="timetable-item-time">10:00am - 11:00am</div>
                          <div class="timetable-item-name">Available</div>
                    ...
                    <div class="col-md-6">
                      <div class="timetable-item">
                        ...
                        <div class="timetable-item-main">
                          <div class="timetable-item-time">11:00am - 12:00pm</div>
                          <div class="timetable-item-name">Available</div>
                          <a href="#" class="btn btn-primary btn-book">Book</a>
                          <div class="timetable-item-like">
                            <i class="fa fa-heart-o" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                      <div class="timetable-item">
                        ...
                        <div class="timetable-item-main">
                          <div class="timetable-item-time">1:00pm - 2:00pm</div>
                          <div class="timetable-item-name">Available</div>
                          <a href="#" class="btn btn-primary btn-book">Book</a>
                          <div class="timetable-item-like">
                            <i class="fa fa-heart-o" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                      <div class="timetable-item">
                        ...
                        <div class="timetable-item-main">
                          <div class="timetable-item-time">2:00pm - 3:00pm</div>
                          <div class="timetable-item-name">Available</div>
                          <a href="#" class="btn btn-primary btn-book">Book</a>
                          <div class="timetable-item-like">
                            <i class="fa fa-heart-o" aria-hidden="true"></i>
